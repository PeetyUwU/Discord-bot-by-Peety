module.exports = {
    ...
    execute(client, message, args, Discord) {
        ...
        .setDescription(" ")
        .addFields()
        .setImage("https://media1.tenor.com/images/72c9b849aa10b222371ebb99a6b1896a/tenor.gif?itemid=8807701")
        ...
        //Mei Misaki https://wallup.net/wp-content/uploads/2016/03/12/299905-Another-Misaki_Mei.jpg
            ...
            .setDescription(" ")
            .addFields()
            .setImage("https://media1.tenor.com/images/b5397d5803883e7d4a4b355d068a7375/tenor.gif?itemid=14223397")
            .setFooter("Made by Peety#1083")
            message.channel.send(Embed)
            console.log("Ahoj command used"/*, ${}*/)
            //sad:   https://media1.tenor.com/images/76d6d1ab30252270844689d3e9dc3214/tenor.gif?itemid=14495462
