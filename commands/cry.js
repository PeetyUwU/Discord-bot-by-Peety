  ...
  execute(client, message, args, Discord) {
    ...
    if (random === 7) {
      Embed.setColor(0xff1100)
        ...
        .addFields()
        .setImage(
          'https://media1.tenor.com/images/0f7b43b390702ac6b3280a8999f38b2d/tenor.gif?itemid=18363911'
        )
        .setFooter('Bot made by Peety#1083');
      message.channel.send(Embed);
      console.log('Cry Used');
